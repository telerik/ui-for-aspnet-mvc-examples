## Sample Overview
This area demonstrates server-rendered detail templates in hierarchical Grid in ASP.NET MVC. The sample shows how to use server-side partial views for detail row content, enabling complex server-side logic in detail templates.

Common techniques shown in this sample:
- Using server DetailTemplate with partial views
- Rendering detail content on server-side
- Passing model data to detail partial views
- Implementing complex detail layouts
- Using server logic in detail templates
- Handling postbacks from detail content
