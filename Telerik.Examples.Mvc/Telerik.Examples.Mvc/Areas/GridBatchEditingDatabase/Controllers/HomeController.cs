...
using Telerik.Examples.Mvc.Areas.GridBatchEditingDatabase.Models;

namespace Telerik.Examples.Mvc.Areas.GridBatchEditingDatabase.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            using (var northwind = new GridBatchEditingDatabaseEntities())
            {
                IQueryable<GridBatchEditingDatabaseProduct> products = northwind.Products;
        ...
        public ActionResult Products_Create([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")] IEnumerable<ProductViewModel> products)
        {
            ...
            var entities = new List<GridBatchEditingDatabaseProduct>();
            if (ModelState.IsValid)
            {
                using (var northwind = new GridBatchEditingDatabaseEntities())
                {
                    foreach (var product in products)
                    {
                        ...
                        var entity = new GridBatchEditingDatabaseProduct
                        {
