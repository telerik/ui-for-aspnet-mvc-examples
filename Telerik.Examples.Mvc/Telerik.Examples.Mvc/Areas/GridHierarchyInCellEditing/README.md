## Sample Overview
This area demonstrates in-cell editing in hierarchical Grid in ASP.NET MVC. The sample shows how to enable cell-by-cell editing in both parent and child grids within a hierarchical structure.

Common techniques shown in this sample:
- Enabling in-cell editing mode for hierarchical grids
- Configuring editing for both master and detail levels
- Handling CRUD operations in nested grids
- Managing foreign keys between parent and child
- Using separate data sources for each level
- Implementing batch save for hierarchy
