...
[assembly: EdmRelationshipAttribute("NorthwindModel", "FK_Employees_Employees", "Employees", RelationshipMultiplicity.ZeroOrOne, typeof(Telerik.Examples.Mvc.Areas.GridMultiSelect.Models.Employee), "Employees1", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridMultiSelect.Models.Employee), true)]
[assembly: EdmRelationshipAttribute("NorthwindModel", "EmployeeTerritories", "Employees", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridMultiSelect.Models.Employee), "Territories", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridMultiSelect.Models.Territory))]
...
namespace Telerik.Examples.Mvc.Areas.GridMultiSelect.Models
{
    ...
    /// </summary>
    public partial class GridMultiSelectEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GridMultiSelectEntities object using the connection string found in the 'GridMultiSelectEntities' section of the application configuration file.
        /// </summary>
        public GridMultiSelectEntities() : base("name=GridMultiSelectEntities", "GridMultiSelectEntities")
        {
        ...
        /// <summary>
        /// Initialize a new GridMultiSelectEntities object.
        /// </summary>
        public GridMultiSelectEntities(string connectionString) : base(connectionString, "GridMultiSelectEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GridMultiSelectEntities object.
        /// </summary>
        public GridMultiSelectEntities(EntityConnection connection) : base(connection, "GridMultiSelectEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
