...
namespace Telerik.Examples.Mvc.Areas.GridEditingPopUpNestedGridBatch.Controllers
{
    public class OrderDetailsController : BaseController
	{
		...
		public ActionResult Create_OrderDetail(OrderDetailViewModel orderDetail, int id)
		{
			...
			{
				var target = new GridEditingPopUpNestedGridBatchOrder_Detail();
				target.OrderID = id;
		...
		private GridEditingPopUpNestedGridBatchOrder_Detail GetOrderDetailByIDs(int productID, int orderID)
		{
