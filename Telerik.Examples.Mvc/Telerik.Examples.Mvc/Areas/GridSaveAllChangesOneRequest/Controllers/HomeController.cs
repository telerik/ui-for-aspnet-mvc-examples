...
using Telerik.Examples.Mvc.Areas.GridSaveAllChangesOneRequest.Models;

namespace Telerik.Examples.Mvc.Areas.GridSaveAllChangesOneRequest.Controllers
{
    public class HomeController : Controller
    {
        ...
        public static List<Employee> employeeList = new List<Employee> {
            new Employee {EmployeeID = 1, Name = "Andrew"},
