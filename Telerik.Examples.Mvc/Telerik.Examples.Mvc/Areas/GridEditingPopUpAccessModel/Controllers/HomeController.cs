...
namespace Telerik.Examples.Mvc.Areas.GridEditingPopUpAccessModel.Controllers
{
    public class HomeController : Controller
    {
		...
		public ActionResult ForeignKeyColumn_Read([DataSourceRequest] DataSourceRequest request, int? parrentGridRecordId)
		{
			if (parrentGridRecordId != null)
			{
				var allOrders = from orders in orderList
								where orders.OrderID == parrentGridRecordId
								select new Order
								{
