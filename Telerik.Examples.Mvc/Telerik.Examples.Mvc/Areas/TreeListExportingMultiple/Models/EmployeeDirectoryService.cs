namespace Telerik.Examples.Mvc.Areas.TreeListExportingMultiple.Models
{
    ...
    {
        private TreeListExportingMultipleEntities db;

        public EmployeeDirectoryService(TreeListExportingMultipleEntities context)
        {
            db = context;
        }

        public EmployeeDirectoryService()
            : this(new TreeListExportingMultipleEntities())
        {
        }
