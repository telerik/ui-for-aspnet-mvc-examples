...
[assembly: EdmRelationshipAttribute("NorthwindModel", "FK_Employees_Employees", "Employees", RelationshipMultiplicity.ZeroOrOne, typeof(Telerik.Examples.Mvc.Areas.GridEditingPopUpMultiSelect.Models.Employee), "Employees1", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridEditingPopUpMultiSelect.Models.Employee), true)]
[assembly: EdmRelationshipAttribute("NorthwindModel", "EmployeeTerritories", "Employees", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridEditingPopUpMultiSelect.Models.Employee), "Territories", RelationshipMultiplicity.Many, typeof(Telerik.Examples.Mvc.Areas.GridEditingPopUpMultiSelect.Models.Territory))]
...
namespace Telerik.Examples.Mvc.Areas.GridEditingPopUpMultiSelect.Models
{
    ...
    /// </summary>
    public partial class GridEditingPopUpMultiSelectEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GridEditingPopUpMultiSelectEntities object using the connection string found in the 'GridEditingPopUpMultiSelectEntities' section of the application configuration file.
        /// </summary>
        public GridEditingPopUpMultiSelectEntities() : base("name=GridEditingPopUpMultiSelectEntities", "GridEditingPopUpMultiSelectEntities")
        {
        ...
        /// <summary>
        /// Initialize a new GridEditingPopUpMultiSelectEntities object.
        /// </summary>
        public GridEditingPopUpMultiSelectEntities(string connectionString) : base(connectionString, "GridEditingPopUpMultiSelectEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GridEditingPopUpMultiSelectEntities object.
        /// </summary>
        public GridEditingPopUpMultiSelectEntities(EntityConnection connection) : base(connection, "GridEditingPopUpMultiSelectEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
