## Sample Overview
This area demonstrates server-side PDF export for Telerik UI components in ASP.NET MVC. The sample shows how to generate and export PDF documents on the server using Telerik Document Processing libraries.

Common techniques shown in this sample:
- Using Telerik Document Processing for PDF generation
- Exporting Grid data to PDF on server
- Creating PDF documents programmatically
- Configuring PDF export settings
- Returning PDF FileResult for download
- Handling server-side PDF rendering
