...
using Telerik.Examples.Mvc.Areas.GridCascadingDropDownFilters.Models;

namespace Telerik.Examples.Mvc.Areas.GridCascadingDropDownFilters.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            using (var northwind = new GridCascadingDropDownFiltersEntities())
            {
                IQueryable<GridCascadingDropDownFiltersCustomer> customers = northwind.Customers;
        ...
        {
            var northwind = new GridCascadingDropDownFiltersEntities();
