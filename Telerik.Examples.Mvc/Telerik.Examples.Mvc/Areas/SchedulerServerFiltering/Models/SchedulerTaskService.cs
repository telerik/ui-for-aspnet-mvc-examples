namespace Telerik.Examples.Mvc.Areas.SchedulerServerFiltering.Models
{
    ...
    {
        private SchedulerServerFilteringEntities db;

        public SchedulerTaskService(SchedulerServerFilteringEntities context)
        {
            db = context;
        }

        public SchedulerTaskService()
            : this(new SchedulerServerFilteringEntities())
        {
        }
