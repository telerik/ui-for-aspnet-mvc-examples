...
namespace KendoMVCWrappers.Models
{
    ...
    /// </summary>
    public partial class NwEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new NwEntities object using the connection string found in the 'NwEntities' section of the application configuration file.
        /// </summary>
        public NwEntities() : base("name=NwEntities", "NwEntities")
        {
        ...
        /// <summary>
        /// Initialize a new NwEntities object.
        /// </summary>
        public NwEntities(string connectionString) : base(connectionString, "NwEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new NwEntities object.
        /// </summary>
        public NwEntities(EntityConnection connection) : base(connection, "NwEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="NorthwindEntities", Name="Product")]
    [Serializable()]
